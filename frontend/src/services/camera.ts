/**
 * h2sense Camera Service & MediaStream Manager
...
export function checkCameraSupport(): {
  ...
  if (!isSecure) {
    return {
      ...
      reason: 'Insecure Context: Browsers disable camera access on plain HTTP local network addresses. Please open h2sense via HTTPS or localhost.'
    };
  }
