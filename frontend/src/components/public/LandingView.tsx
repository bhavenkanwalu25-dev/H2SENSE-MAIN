  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 text-slate-900 select-none">
        ...
        <div className="mt-6 p-5 rounded-2xl bg-white border border-slate-200 shadow-xs">
          ...
          {showTechnicalDetails && (
            <div className="mt-3 pt-3 border-t border-slate-100 text-xs text-slate-600 space-y-2">
              ...
              <p>
                <strong className="text-slate-900">Device Classification:</strong> h2sense is a passive cumulative exposure dosimeter system. It is <strong className="text-slate-900">NOT</strong> an instantaneous real-time detector, not a replacement for mandatory real-time electronic alarms, and not a medical diagnostic device.
              </p>
            </div>
          )}
        </div>
      ...
      <footer className="px-6 py-10 max-w-7xl mx-auto border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <div className="text-sm font-bold text-slate-900 font-mono">h2sense — Passive Exposure Intelligence</div>
