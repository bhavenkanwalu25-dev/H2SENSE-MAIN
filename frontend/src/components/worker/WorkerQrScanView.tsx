  ...
  const handleVerifyBadge = useCallback(async (rawBadgePayload: string) => {
    ...
    try {
      ...
      if (data.valid) {
        ...
        setVerifiedBadge(null);
        setErrorMessage(data.message || 'This QR code is not a registered h2sense badge.');
          ...
          <div className="p-6 rounded-2xl bg-white border-2 border-red-500/50 shadow-card text-center space-y-4 animate-fadeIn">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-red-700 font-medium leading-relaxed">
                {errorMessage || 'This QR code is not a registered h2sense badge.'}
              </p>
              <p className="text-xs text-slate-500 leading-relaxed">
                Please scan the QR code printed on your h2sense dosimeter.
              </p>
            </div>
