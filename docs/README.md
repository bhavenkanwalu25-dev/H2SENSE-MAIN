# h2sense System Documentation

**SIH 2026 — Problem Statement SIH26118 (Mangalore Refinery and Petrochemicals Limited - MRPL)**

## Architecture Overview

h2sense is a colorimetric cumulative hydrogen sulfide (H₂S) dosimeter and occupational safety intelligence platform designed for industrial refinery environments.
