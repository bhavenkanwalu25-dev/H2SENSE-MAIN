"""
h2sense Master Synthetic Wristband Dataset & Physical Strip Asset Generator
=============================================================================
DISCLAIMER:
...
def generate_printable_strip_sheet(output_path: str):
    ...
    cv2.putText(sheet, "h2sense - SYNTHETIC PROTOTYPE REACTION STRIP SHEET", (120, 150),
    ...
    # Footer
    cv2.putText(sheet, "h2sense SIH2026 | Mangalore Refinery and Petrochemicals Limited (MRPL) | Synthetic Software Test Harness",
...
def render_wristband_badge_image(
    ...
    cv2.putText(img, "h2sense DOSIMETER", (margin + 60, margin + 55),
